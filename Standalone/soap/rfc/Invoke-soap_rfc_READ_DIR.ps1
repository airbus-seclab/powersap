<#
    .Synopsis
      Calls SOAP RZL_READ_DIR_LOCAL
    .Description
      List OS directory content
      Calls the function RZL_READ_DIR_LOCAL, through the /sap/bc/soap/rfc SOAP 
...
<env:Body>
    <n1:RZL_READ_DIR_LOCAL xmlns:n1="urn:sap-com:document:sap:rfc:functions" env:encodingStyle="http://schemas.xmlsoap.org/soap/encoding/">
        <NAME>'+$dir_path+'</NAME>
        <FILE_TBL>
            <NAME></NAME>
            <SIZE></SIZE>
        </FILE_TBL>
    </n1:RZL_READ_DIR_LOCAL>
</env:Body>
</env:Envelope>'
