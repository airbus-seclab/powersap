<#
    .Synopsis
      Calls SOAP DX_FILE_READ
    .Description
      Retrieve OS file content
      Calls the function DX_FILE_READ, through the /sap/bc/soap/rfc SOAP 
...
<env:Body>
    <n1:DX_FILE_READ xmlns:n1="urn:sap-com:document:sap:rfc:functions" env:encodingStyle="http://schemas.xmlsoap.org/soap/encoding/">
