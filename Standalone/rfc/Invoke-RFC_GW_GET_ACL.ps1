  <# TO TEST
    ...
    .Description
      Get parameter values with FM SBUF_PARAMETER_GET, check if provided file exist with FM PFL_CHECK_OS_FILE_EXISTENCE then display content with FM DX_FILE_READ 
    .Author
      @_1ggy
  #>
